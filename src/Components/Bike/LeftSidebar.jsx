    ...
    <>
      <div className='leftsidebar' >
        ...
        <div className='category'>
          <h2>Category</h2>
          <ul>
          <li> <input type='radio' name='category' /> <label>All Motorcycles</label>          </li>
          <li> <input type='radio' name='category' /><label>Super Bike</label></li>
          <li> <input type='radio' name='category' /><label>Vintage Bike</label></li>
          <li> <input type='radio' name='category' /><label>Custom Bike</label></li>
          </ul>
        </div>
        <hr/>
        ...
        <div className='fuel'>
          ...
          <ul>
            ...
            <li> <input type='radio' name='fuel' /><label>Diesel</label></li>
